...
<!--    $form->field($model, 'i_Fk_User')->textInput(['readonly' => true,'value'=>$userID]) -->
    <?= $form->field($model, 'i_Fk_User')->hiddenInput(['value'=> $userID])->label(false)?>

<!--    $form->field($model, 'i_Score')->textInput()-->
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? 'Send score' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
